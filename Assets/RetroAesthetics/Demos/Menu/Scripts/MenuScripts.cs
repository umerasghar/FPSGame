...
namespace RetroAesthetics.Demos {
	...
	public class MenuScripts : MonoBehaviour {
			...
			if (levelScene != null) {
				if (_cameraEffect != null) {
					if (loadingScene != null) {
						_loadingSceneAsync = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(loadingScene);
		...
		private void LoadNextScene() {
			...
			UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(levelScene);
		}
	}
}
